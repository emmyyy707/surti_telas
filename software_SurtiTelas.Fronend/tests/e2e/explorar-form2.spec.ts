...
test('explorar formulario paso 2', async ({ page }) => {
  ...
  fs.writeFileSync('playwright-report/form-step2.html', html, 'utf8');
  ...
  fs.writeFileSync('playwright-report/form-step2-inputs.json', JSON.stringify(inputInfo, null, 2), 'utf8');
});
