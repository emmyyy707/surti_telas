...
export function VentasModule({ activeTab }: VentasModuleProps) {
  ...
  const [clientes, setClientes] = useState<Cliente[]>([
    ...
    { id: '2', nombre: 'Mará González', email: 'maria@example.com', telefono: '555-3002', direccion: 'Av. 15 #45-67', totalCompras: 23000, ultimaCompra: '2024-12-09', estado: 'activo' },
    ...
    { id: '4', nombre: 'Ana Martónez', email: 'ana@example.com', telefono: '555-3004', direccion: 'Calle 5 #78-90', totalCompras: 31000, ultimaCompra: '2024-12-07', estado: 'activo' },
    { id: '5', nombre: 'Pedro Rodróguez', email: 'pedro@example.com', telefono: '555-3005', direccion: 'Av. 20 #34-56', totalCompras: 12000, ultimaCompra: '2024-11-28', estado: 'inactivo' },
    { id: '6', nombre: 'Laura Sónchez', email: 'laura@example.com', telefono: '555-3006', direccion: 'Calle 22 #40-50', totalCompras: 27000, ultimaCompra: '2024-12-11', estado: 'activo' },
    ...
    { id: '13', nombre: 'Miguel óngel Ruiz', email: 'miguel@example.com', telefono: '555-3013', direccion: 'Av. 40 #75-85', totalCompras: 11000, ultimaCompra: '2024-11-15', estado: 'inactivo' },
    { id: '14', nombre: 'Andrea Jimónez', email: 'andrea@example.com', telefono: '555-3014', direccion: 'Carrera 28 #50-60', totalCompras: 33000, ultimaCompra: '2024-12-15', estado: 'activo' },
    { id: '15', nombre: 'Jorge Hernñdez', email: 'jorge@example.com', telefono: '555-3015', direccion: 'Calle 42 #22-32', totalCompras: 20000, ultimaCompra: '2024-12-16', estado: 'activo' },
  ]);

  const [pedidos, setPedidos] = useState<Pedido[]>([
    { id: 'PED-001', cliente: 'Juan Pérez', productos: 5, total: 15000, estado: 'procesando', fecha: '2024-12-10', metodoPago: 'Tarjeta' },
    { id: 'PED-002', cliente: 'Mará González', productos: 8, total: 23000, estado: 'completado', fecha: '2024-12-09', metodoPago: 'Efectivo' },
    { id: 'PED-003', cliente: 'Carlos López', productos: 6, total: 18500, estado: 'pendiente', fecha: '2024-12-08', metodoPago: 'Transferencia' },
    { id: 'PED-004', cliente: 'Ana Martónez', productos: 10, total: 31000, estado: 'procesando', fecha: '2024-12-07', metodoPago: 'Tarjeta' },
    { id: 'PED-005', cliente: 'Pedro Rodróguez', productos: 4, total: 12000, estado: 'completado', fecha: '2024-12-06', metodoPago: 'Efectivo' },
    { id: 'PED-006', cliente: 'Laura Sónchez', productos: 7, total: 27000, estado: 'completado', fecha: '2024-12-11', metodoPago: 'Tarjeta' },
    ...
    { id: 'PED-013', cliente: 'Miguel óngel Ruiz', productos: 2, total: 11000, estado: 'cancelado', fecha: '2024-11-15', metodoPago: 'Tarjeta' },
    { id: 'PED-014', cliente: 'Andrea Jimónez', productos: 13, total: 33000, estado: 'pendiente', fecha: '2024-12-15', metodoPago: 'Transferencia' },
    { id: 'PED-015', cliente: 'Jorge Hernñdez', productos: 8, total: 20000, estado: 'completado', fecha: '2024-12-16', metodoPago: 'Efectivo' },
  ]);
  ...
  const contactos = [
    { id: '1', cliente: 'Laura Sónchez', email: 'laura@example.com', telefono: '555-4001', asunto: 'Consulta sobre personalización', fecha: '2024-12-11 10:30', estado: 'nuevo' },
    ...
    { id: '4', cliente: 'Andrós López', email: 'andres@example.com', telefono: '555-4004', asunto: 'Información de precios mayoristas', fecha: '2024-12-12 11:45', estado: 'nuevo' },
    { id: '5', cliente: 'Valeria Castro', email: 'valeria@example.com', telefono: '555-4005', asunto: 'Cambio de dirección de enváo', fecha: '2024-12-12 14:20', estado: 'resuelto' },
    ...
    { id: '7', cliente: 'Daniela Morales', email: 'daniela@example.com', telefono: '555-4007', asunto: 'Solicitud de católogo digital', fecha: '2024-12-13 16:00', estado: 'resuelto' },
    ...
    { id: '11', cliente: 'Mariana Jimónez', email: 'mariana@example.com', telefono: '555-4011', asunto: 'Personalización de logo corporativo', fecha: '2024-12-15 12:00', estado: 'en_proceso' },
    { id: '12', cliente: 'Gabriel Hernñdez', email: 'gabriel@example.com', telefono: '555-4012', asunto: 'Consulta de tiempos de entrega', fecha: '2024-12-16 10:00', estado: 'nuevo' },
    { id: '13', cliente: 'Sofá Ramírez', email: 'sofia@example.com', telefono: '555-4013', asunto: 'Información de garantás', fecha: '2024-12-16 15:30', estado: 'resuelto' },
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">Gestión de clientes, católogo, pedidos y facturación</p>
      </div>
      ...
      <Tabs defaultValue={getCurrentTab()} className="space-y-6">
        ...
        {/* Tab: Católogo digital */}
        <TabsContent value="catalogo" className="space-y-6">
          <Card className="p-6 bg-white rounded-xl shadow-sm">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3 className="font-semibold text-gray-900">Católogo de Productos</h3>
            ...
            <div className="text-center py-12 text-gray-500">
              ...
              <p>El católogo digital se gestiona desde el módulo de Inventario</p>
              <p className="text-sm mt-2">Aquí podrós ver los productos disponibles para la venta en lónea</p>
            </div>
          </Card>
        </TabsContent>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200">
                    ...
                    <th className="text-left py-3 px-4 text-sm font-medium text-gray-600">Mótodo de Pago</th>
