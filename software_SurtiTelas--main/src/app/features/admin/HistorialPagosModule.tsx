    ...
    <div className="space-y-6 p-6">
      ...
      <Card className="p-5 bg-purple-50 border-purple-200">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="text-purple-900 mb-1">?? Sistema de Auditorá Completo</h3>
      ...
      <Card className="p-6 bg-white">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            <label className="text-sm text-gray-700 mb-2 block">Peréodo</label>
                ...
                return paginated.map((payment) => (
                  <TableRow key={payment.id} className="hover:bg-gray-50">
                    ...
                    <TableCell>
                      ...
                      >
                        {payment.status === 'en_verificacion' && '? En Verificación'}
                        {payment.status === 'aprobado' && '? Aprobado'}
                        {payment.status === 'denegado' && '? Denegado'}
                      </Badge>
                    </TableCell>
              ...
              <Card className="p-5 bg-blue-50 border-blue-200">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    >
                      {selectedPayment.status === 'en_verificacion' && '? En Verificación'}
                      {selectedPayment.status === 'aprobado' && '? Aprobado'}
                      {selectedPayment.status === 'denegado' && '? Denegado'}
                    </Badge>
                  </div>
                </div>
              </Card>
