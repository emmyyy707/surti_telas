...
export function DevolucionesModule() {
  const [devoluciones, setDevoluciones] = useState<Devolucion[]>([
    { id: '1', codigo: 'DEV-001', producto: 'Camiseta Bósica Blanca', cliente: 'Juan Pérez', cantidad: 5, motivo: 'Defecto de fabricación', estado: 'en_revision', accionTomada: 'Pendiente inspección', fecha: '2024-12-11', inspectorNombre: '-' },
    { id: '2', codigo: 'DEV-002', producto: 'Camiseta Polo Azul', cliente: 'Mará González', cantidad: 3, motivo: 'Talla incorrecta', estado: 'procesada', accionTomada: 'Cambio por talla correcta', fecha: '2024-12-10', inspectorNombre: 'Carlos Díaz' },
    { id: '3', codigo: 'DEV-003', producto: 'Camiseta Estampada Logo', cliente: 'Carlos López', cantidad: 2, motivo: 'Estampado defectuoso', estado: 'reincorporada', accionTomada: 'Reincorporada al inventario', fecha: '2024-12-09', inspectorNombre: 'Ana Martónez' },
    { id: '4', codigo: 'DEV-004', producto: 'Camiseta Deportiva', cliente: 'Ana Martónez', cantidad: 1, motivo: 'Color no coincide', estado: 'segregada', accionTomada: 'Segregada - descarte', fecha: '2024-12-08', inspectorNombre: 'Carlos Díaz' },
    { id: '5', codigo: 'DEV-005', producto: 'Camiseta Bósica Negra', cliente: 'Pedro Rodróguez', cantidad: 4, motivo: 'Daáo en transporte', estado: 'en_revision', accionTomada: 'En proceso de inspección', fecha: '2024-12-11', inspectorNombre: '-' },
    { id: '6', codigo: 'DEV-006', producto: 'Camiseta Infantil', cliente: 'Laura Sónchez', cantidad: 2, motivo: 'No cumple expectativas', estado: 'rechazada', accionTomada: 'Devolución rechazada', fecha: '2024-12-07', inspectorNombre: 'Ana Martónez' },
  ]);
