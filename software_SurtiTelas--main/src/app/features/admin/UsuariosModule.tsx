...
export function UsuariosModule({ activeTab }: UsuariosModuleProps) {
  const [usuarios, setUsuarios] = useState<Usuario[]>([
    { id: '1', avatar: 'A', nombre: 'Ana Garcá', email: 'ana@surticamisetas.com', rol: 'Administrador', estado: 'activo', ultimoAcceso: '2024-12-11 09:30', telefono: '555-0101', fechaCreacion: '2024-01-15' },
    ...
    { id: '3', avatar: 'M', nombre: 'Mará López', email: 'maria@surticamisetas.com', rol: 'Asesor de Ventas', estado: 'activo', ultimoAcceso: '2024-12-10 18:45', telefono: '555-0103', fechaCreacion: '2024-03-10' },
    ...
    { id: '12', avatar: 'G', nombre: 'Gabriela Nóóez', email: 'gabriela@surticamisetas.com', rol: 'Producción', estado: 'activo', ultimoAcceso: '2024-12-10 16:30', telefono: '555-0112', fechaCreacion: '2024-09-15' },
    { id: '13', avatar: 'H', nombre: 'Hóctor Rojas', email: 'hector@surticamisetas.com', rol: 'Administrador', estado: 'activo', ultimoAcceso: '2024-12-11 09:00', telefono: '555-0113', fechaCreacion: '2024-10-01' },
  ...
  const auditoria = [
    { usuario: 'Ana Garcá', accion: 'Login exitoso', fecha: '2024-12-11 09:30', ip: '192.168.1.100' },
    { usuario: 'Luis Pérez', accion: 'Modificó un producto', fecha: '2024-12-11 08:45', ip: '192.168.1.101' },
    { usuario: 'Mará López', accion: 'Creó un pedido', fecha: '2024-12-11 08:15', ip: '192.168.1.102' },
    ...
    <div className="p-4 sm:p-6 space-y-6">
      ...
      <Tabs defaultValue={getCurrentTab()} className="space-y-6">
              ...
              <Dialog open={openDialog} onOpenChange={setOpenDialog}>
                ...
                <DialogContent className="max-w-2xl">
                  ...
                  <div className="grid grid-cols-2 gap-4 py-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="password">Contraseáa</Label>
                      <Input id="password" type="password" placeholder="óóóóóóóó" />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="confirm-password">Confirmar contraseáa</Label>
                      <Input id="confirm-password" type="password" placeholder="óóóóóóóó" />
                    </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200">
                    ...
                    <th className="text-left py-3 px-4 text-sm font-medium text-gray-600">óltimo acceso</th>
        ...
        <TabsContent value="seguridad" className="space-y-6">
          <Card className="p-6 bg-white rounded-xl shadow-sm">
            <h3 className="font-semibold text-gray-900 mb-4">Auditorá de Actividad</h3>
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200">
          ...
          <Card className="p-6 bg-white rounded-xl shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div>
                  <p className="font-medium text-gray-900">Bloqueo automótico</p>
                  <p className="text-sm text-gray-600">Bloquear cuenta despuós de 3 intentos fallidos</p>
                </div>
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Requerir cambio de contraseáa cada 90 dás</p>
                </div>
                <Switch />
              </div>
            </div>
