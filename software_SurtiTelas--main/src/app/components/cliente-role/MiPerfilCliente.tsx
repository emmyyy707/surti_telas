...
export function MiPerfilCliente({ userName, onUpdateUserName }: MiPerfilClienteProps) {
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6">
      ...
      <Card className="p-6 bg-white rounded-xl shadow-sm">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
          ...
          <div className="flex items-center gap-6">
            <div className="h-24 w-24 rounded-full bg-gray-900 text-white flex items-center justify-center text-3xl font-bold">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Cliente desde Enero 2025</p>
            </div>
          </div>
          ...
          <div className="flex gap-2">
            {isEditing ? (
              ...
              <Button className="bg-gray-900 hover:bg-gray-800" onClick={handleEdit}>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            <div>
              ...
              <p className="text-sm text-gray-600">Protege tu cuenta con verificación en dos pasos</p>
            </div>
            <Button variant="outline" size="sm">
              Activar
            </Button>
      ...
      {/* Zona de Peligro */}
      <Card className="p-6 bg-white rounded-xl shadow-sm border-2 border-red-200">
