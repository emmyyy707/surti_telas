...
export function CatalogoCliente() {
  ...
  const productos: Producto[] = [
    {
      ...
      descripcion: 'Camiseta de algodón 100% de alta calidad, perfecta para el uso diario. Diseño clásico y cómodo.',
      precio: 45000,
    ...
    },
    {
      ...
      descripcion: 'Polo deportivo con tecnología dry-fit para máximo rendimiento. Ideal para actividades físicas.',
      precio: 85000,
      categoria: 'Polos',
      tallas: ['S', 'M', 'L', 'XL'],
      colores: [
    ...
    },
    {
      ...
      descripcion: 'Sudadera con capucha ajustable, bolsillo canguro y tejido suave. Perfecta para climas fríos.',
      precio: 120000,
      categoria: 'Sudaderas',
      tallas: ['M', 'L', 'XL', 'XXL'],
      colores: [
    ...
    },
    {
      ...
      descripcion: 'Pantalón deportivo con cintura elástica y bolsillos laterales. Tela transpirable y cómoda.',
      precio: 65000,
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-semibold text-gray-900">Catálogo de Productos</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {productosFiltrados.map((producto) => (
          <Card key={producto.id} className="overflow-hidden bg-white rounded-xl shadow-sm hover:shadow-lg transition-all group">
            ...
            <div className="p-4">
              ...
              <div className="flex items-center justify-between mb-3">
                <div>
                  <p className="text-xl font-bold text-gray-900">${producto.precio.toLocaleString()}</p>
                  {producto.precioAnterior && (
                    <p className="text-sm text-gray-500 line-through">${producto.precioAnterior.toLocaleString()}</p>
                  )}
                </div>
              </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="flex items-center gap-1 mt-2">
                        ...
                        <span className="text-sm text-gray-600 ml-1">({selectedProducto.rating})</span>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3">
                        <button
                          ...
                          className="h-10 w-10 border-2 border-gray-300 rounded-lg flex items-center justify-center hover:border-gray-400 transition-colors"
                        >
