...
export function ProduccionModule({ activeTab }: ProduccionModuleProps) {
  ...
  const [talleres, setTalleres] = useState<Taller[]>([
    { id: '1', nombre: 'Confecciones El Roble', contacto: 'Pedro Martínez', telefono: '555-2001', direccion: 'Calle 15 #45-67', estado: 'activo', especialidad: 'Camisetas básicas' },
    ...
    { id: '4', nombre: 'Taller San José', contacto: 'Carmen Ruiz', telefono: '555-2004', direccion: 'Carrera 10 #78-90', estado: 'inactivo', especialidad: 'Infantiles' },
    { id: '5', nombre: 'Moda y Estilo', contacto: 'Andrés López', telefono: '555-2005', direccion: 'Calle 25 #10-15', estado: 'activo', especialidad: 'Camisetas premium' },
    { id: '6', nombre: 'Taller La Costura', contacto: 'María Sánchez', telefono: '555-2006', direccion: 'Av. Norte #50-30', estado: 'activo', especialidad: 'Bordados' },
    { id: '7', nombre: 'Confecciones Rápidas', contacto: 'Jorge Ramírez', telefono: '555-2007', direccion: 'Carrera 5 #20-40', estado: 'activo', especialidad: 'Producción masiva' },
    { id: '8', nombre: 'Taller Artesanal', contacto: 'Diana Castro', telefono: '555-2008', direccion: 'Calle 40 #15-25', estado: 'activo', especialidad: 'Diseños únicos' },
    ...
    { id: '11', nombre: 'Confecciones del Norte', contacto: 'Luis Hernández', telefono: '555-2011', direccion: 'Av. Central #80-90', estado: 'activo', especialidad: 'Deportivas' },
    { id: '12', nombre: 'Taller Moderno', contacto: 'Sandra Vargas', telefono: '555-2012', direccion: 'Carrera 20 #45-55', estado: 'activo', especialidad: 'Diseño moderno' },
    ...
    { id: '14', nombre: 'Taller Express 24h', contacto: 'Carolina Jiménez', telefono: '555-2014', direccion: 'Av. Sur #60-70', estado: 'activo', especialidad: 'Urgencias' },
    { id: '15', nombre: 'Confecciones Premium', contacto: 'Miguel Ángel Ríos', telefono: '555-2015', direccion: 'Calle 50 #18-28', estado: 'activo', especialidad: 'Lujo' },
  ]);

  const [asignaciones, setAsignaciones] = useState<AsignacionProduccion[]>([
    { id: '1', taller: 'Confecciones El Roble', pedido: 'PED-001', producto: 'Camiseta Básica Blanca', cantidad: 100, fechaAsignacion: '2024-12-08', fechaEntregaEstimada: '2024-12-15', estado: 'en_produccion', etapaKanban: 'confeccion' },
    ...
    { id: '9', taller: 'Confecciones Rápidas', pedido: 'PED-009', producto: 'Camiseta Básica Azul', cantidad: 150, fechaAsignacion: '2024-12-06', fechaEntregaEstimada: '2024-12-13', estado: 'completado', etapaKanban: 'finalizado' },
    { id: '10', taller: 'Taller Artesanal', pedido: 'PED-010', producto: 'Camiseta Diseño Único', cantidad: 20, fechaAsignacion: '2024-12-15', fechaEntregaEstimada: '2024-12-22', estado: 'asignado', etapaKanban: 'corte' },
  ...
  const [controlPrendas, setControlPrendas] = useState<ControlPrendas[]>([
    ...
    { id: '5', taller: 'Confecciones Rápidas', pedido: 'PED-009', prendasEntregadas: 150, prendasRecibidas: 148, prendasDefectuosas: 2, fechaEntrega: '2024-12-06', fechaRecepcion: '2024-12-13', estado: 'con_observaciones' },
        ...
        <TabsContent value="kanban" className="space-y-6">
          <div className="mb-4 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-blue-900">
              <strong>ðŸ’¡ Tip:</strong> Arrastra y suelta las tarjetas entre columnas para actualizar el estado de producción en tiempo real.
            </p>
          </div>
                        ...
                        <div className="hidden group-hover:flex gap-2 pt-2">
                          <Button
                            ...
                            onClick={() => {
                              ...
                              toast.success('ðŸŽ‰ Pedido completado!');
                            }}
                          >
