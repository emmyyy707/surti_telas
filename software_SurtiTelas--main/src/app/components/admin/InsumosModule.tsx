...
export function InsumosModule() {
  const [insumos, setInsumos] = useState<Insumo[]>([
    ...
    { id: '6', codigo: 'INS-006', nombre: 'Botones plásticos', categoria: 'Accesorios', unidadMedida: 'unidades', cantidadDisponible: 350, cantidadMinima: 200, precioUnitario: 100, proveedor: 'Insumos Textiles SA', estado: 'disponible', ultimaCompra: '2024-11-25', ubicacion: 'Bodega C-3' },
  ...
  const exportToCSV = () => {
    const headers = ['Código', 'Nombre', 'Categoría', 'Unidad', 'Cantidad', 'Mínimo', 'Precio', 'Proveedor', 'Estado'];
