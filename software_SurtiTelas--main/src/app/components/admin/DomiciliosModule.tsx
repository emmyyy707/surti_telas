...
export function DomiciliosModule() {
  const [domicilios, setDomicilios] = useState<Domicilio[]>([
    {
      ...
      productos: 'Camiseta Básica (2), Camiseta Premium (1)',
      valor: 150000,
      tracking: [
    ...
    },
    {
      ...
      productos: 'Camiseta Básica (5)',
      valor: 125000,
      tracking: [
        { fecha: '2024-12-18', hora: '07:30', estado: 'asignado', descripcion: 'Pedido asignado, pendiente de despacho' }
      ]
    },
    { id: '5', pedidoId: 'ORD-005', cliente: 'Laura Sánchez', direccion: 'Calle 50 #22-33', ciudad: 'Bogotá', telefono: '+57 320 123 9876', domiciliario: 'Carlos Mendoza', estado: 'entregado', fechaPedido: '2024-12-14', fechaAsignacion: '2024-12-15', fechaEntrega: '2024-12-18', productos: 'Camiseta Premium (3)', valor: 180000, tracking: [] },
    ...
    { id: '7', pedidoId: 'ORD-007', cliente: 'Carolina Morales', direccion: 'Carrera 60 #40-50', ciudad: 'Medellín', telefono: '+57 300 789 1234', domiciliario: '-', estado: 'pendiente', fechaPedido: '2024-12-20', productos: 'Camiseta Polo (2)', valor: 140000, tracking: [] },
    { id: '8', pedidoId: 'ORD-008', cliente: 'Roberto Silva', direccion: 'Calle 88 #20-30', ciudad: 'Bogotá', telefono: '+57 315 987 6543', domiciliario: 'Luis Gómez', estado: 'asignado', fechaPedido: '2024-12-18', fechaAsignacion: '2024-12-19', productos: 'Camiseta Básica (6)', valor: 150000, tracking: [] },
    { id: '9', pedidoId: 'ORD-009', cliente: 'Patricia Gómez', direccion: 'Av. 40 #55-65', ciudad: 'Cali', telefono: '+57 320 654 3210', domiciliario: 'Andrés Rojas', estado: 'en_ruta', fechaPedido: '2024-12-17', fechaAsignacion: '2024-12-18', productos: 'Camiseta Premium (5)', valor: 200000, tracking: [] },
    ...
    { id: '11', pedidoId: 'ORD-011', cliente: 'Sandra Vargas', direccion: 'Calle 70 #18-28', ciudad: 'Medellín', telefono: '+57 300 147 2589', domiciliario: '-', estado: 'pendiente', fechaPedido: '2024-12-21', productos: 'Camiseta Básica (3)', valor: 90000, tracking: [] },
    { id: '12', pedidoId: 'ORD-012', cliente: 'Miguel Ángel Ruiz', direccion: 'Av. 25 #45-55', ciudad: 'Bogotá', telefono: '+57 315 258 3691', domiciliario: 'Pedro López', estado: 'asignado', fechaPedido: '2024-12-19', fechaAsignacion: '2024-12-20', productos: 'Camiseta Polo (4)', valor: 240000, tracking: [] },
    { id: '13', pedidoId: 'ORD-013', cliente: 'Andrea Jiménez', direccion: 'Carrera 50 #60-70', ciudad: 'Cali', telefono: '+57 320 369 1472', domiciliario: 'Luis Gómez', estado: 'entregado', fechaPedido: '2024-12-11', fechaAsignacion: '2024-12-12', fechaEntrega: '2024-12-15', productos: 'Camiseta Premium (8)', valor: 320000, tracking: [] },
    { id: '14', pedidoId: 'ORD-014', cliente: 'Jorge Hernández', direccion: 'Calle 95 #35-45', ciudad: 'Medellín', telefono: '+57 310 741 8529', domiciliario: 'Andrés Rojas', estado: 'en_ruta', fechaPedido: '2024-12-20', fechaAsignacion: '2024-12-21', productos: 'Camiseta Deportiva (3)', valor: 135000, tracking: [] },
    { id: '15', pedidoId: 'ORD-015', cliente: 'Valeria Castro', direccion: 'Av. 60 #25-35', ciudad: 'Bogotá', telefono: '+57 320 852 9631', domiciliario: '-', estado: 'pendiente', fechaPedido: '2024-12-22', productos: 'Camiseta Básica (4)', valor: 120000, tracking: [] },
  ]);
  ...
  const [domiciliarios, setDomiciliarios] = useState<Domiciliario[]>([
    ...
    { id: '3', nombre: 'Luis Gómez', telefono: '+57 320 333 4444', vehiculo: 'Bicicleta eléctrica', estado: 'disponible', pedidosHoy: 2, calificacion: 4.7 },
    { id: '4', nombre: 'Andrés Rojas', telefono: '+57 315 444 5555', vehiculo: 'Moto Suzuki 125', estado: 'descanso', pedidosHoy: 4, calificacion: 4.6 },
    { id: '5', nombre: 'Diego Martínez', telefono: '+57 300 555 6666', vehiculo: 'Moto Kawasaki 150', estado: 'disponible', pedidosHoy: 3, calificacion: 4.5 },
    { id: '6', nombre: 'Laura Sánchez', telefono: '+57 310 666 7777', vehiculo: 'Moto Honda 125', estado: 'en_ruta', pedidosHoy: 6, calificacion: 4.8 },
    { id: '7', nombre: 'Fernando Torres', telefono: '+57 320 777 8888', vehiculo: 'Bicicleta eléctrica', estado: 'disponible', pedidosHoy: 1, calificacion: 4.9 },
    ...
    { id: '11', nombre: 'Miguel Hernández', telefono: '+57 320 111 2222', vehiculo: 'Bicicleta eléctrica', estado: 'disponible', pedidosHoy: 1, calificacion: 4.5 },
    { id: '12', nombre: 'Andrea Jiménez', telefono: '+57 315 222 3333', vehiculo: 'Moto Yamaha 125', estado: 'en_ruta', pedidosHoy: 3, calificacion: 4.9 },
  ]);
                                      ...
                                      {domiciliarios
                                        ...
                                        .map(d => (
                                          <SelectItem key={d.id} value={d.id}>
                                            {d.nombre} - {d.vehiculo} (â˜… {d.calificacion})
                                          </SelectItem>
                                        ))}
                                    </SelectContent>
                                  </Select>
