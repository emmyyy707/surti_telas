...
interface Insumo {
  ...
  unidad: string;
  proveedor: string;
  estado: 'disponible' | 'bajo' | 'crítico';
...
export function InventarioModule({ activeTab }: InventarioModuleProps) {
  ...
  const [insumos, setInsumos] = useState<Insumo[]>([
    ...
    { id: '4', nombre: 'Hilo Negro', tipo: 'Hilo', cantidad: 12, unidad: 'carretes', proveedor: 'Hilos del Norte', estado: 'crítico', precioUnitario: 5 },
    { id: '5', nombre: 'Botones Plásticos', tipo: 'Accesorios', cantidad: 500, unidad: 'unidades', proveedor: 'Accesorios Plus', estado: 'disponible', precioUnitario: 0.5 },
    ...
    { id: '10', nombre: 'Cierres Metálicos', tipo: 'Accesorios', cantidad: 250, unidad: 'unidades', proveedor: 'Accesorios Plus', estado: 'disponible', precioUnitario: 2 },
    ...
    { id: '12', nombre: 'Elásticos', tipo: 'Accesorios', cantidad: 300, unidad: 'metros', proveedor: 'Accesorios Plus', estado: 'disponible', precioUnitario: 1.5 },
    ...
    { id: '20', nombre: 'Tinta de Estampado Azul', tipo: 'Tintas', cantidad: 8, unidad: 'litros', proveedor: 'Tintas y Diseños', estado: 'crítico', precioUnitario: 80 },
  ]);

  const [productosTerminados, setProductosTerminados] = useState<ProductoTerminado[]>([
    { id: '1', referencia: 'CAM-001', nombre: 'Camiseta Básica Blanca', stock: 150, estado: 'disponible', precio: 80, categoria: 'Básicas' },
    { id: '2', referencia: 'CAM-002', nombre: 'Camiseta Básica Negra', stock: 120, estado: 'disponible', precio: 80, categoria: 'Básicas' },
    ...
    { id: '7', referencia: 'CAM-007', nombre: 'Camiseta Básica Gris', stock: 100, estado: 'disponible', precio: 80, categoria: 'Básicas' },
    { id: '8', referencia: 'CAM-008', nombre: 'Camiseta Cuello V Negro', stock: 90, estado: 'disponible', precio: 95, categoria: 'Básicas' },
    ...
    { id: '12', referencia: 'CAM-012', nombre: 'Camiseta Manga Larga Negra', stock: 55, estado: 'disponible', precio: 110, categoria: 'Básicas' },
    ...
    { id: '16', referencia: 'CAM-016', nombre: 'Camiseta Estampada Artística', stock: 15, estado: 'bajo', precio: 160, categoria: 'Personalizadas' },
    { id: '17', referencia: 'CAM-017', nombre: 'Camiseta Básica Azul', stock: 110, estado: 'disponible', precio: 80, categoria: 'Básicas' },
  ...
  const [proveedores, setProveedores] = useState<Proveedor[]>([
    ...
    { id: '2', nombre: 'Hilos del Norte', contacto: 'María González', telefono: '555-1002', email: 'info@hilosdelnorte.com', insumosAsociados: 8, estado: 'activo' },
    ...
    { id: '6', nombre: 'Confecciones del Sur', contacto: 'Laura Martínez', telefono: '555-1006', email: 'info@confeccionesdelsur.com', insumosAsociados: 10, estado: 'activo' },
    { id: '7', nombre: 'Distribuidora Textil', contacto: 'Miguel Ángel Torres', telefono: '555-1007', email: 'ventas@distritextil.com', insumosAsociados: 18, estado: 'activo' },
    { id: '8', nombre: 'Bordados y Más', contacto: 'Patricia Gómez', telefono: '555-1008', email: 'contacto@bordadosymas.com', insumosAsociados: 5, estado: 'activo' },
    ...
    { id: '12', nombre: 'Estampados Creativos', contacto: 'Andrea Jiménez', telefono: '555-1012', email: 'contacto@estampadoscreativos.com', insumosAsociados: 7, estado: 'activo' },
    { id: '13', nombre: 'Telas Importadas Ltda.', contacto: 'Jorge Hernández', telefono: '555-1013', email: 'ventas@telasimportadas.com', insumosAsociados: 16, estado: 'activo' },
  ...
  const insumosCriticos = insumos.filter(i => i.estado === 'crítico').length;
