...
export function NotificationsDropdown({ onNavigate }: NotificationsDropdownProps) {
  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    ...
    },
    {
      ...
      type: 'info',
      title: 'Nuevo Pedido',
      message: 'Pedido PED-108 recibido de María González',
      time: 'Hace 12 min',
      read: false,
      icon: Package,
    ...
    },
    {
      ...
      message: 'Domicilio del pedido ORD-003 está retrasado',
      time: 'Hace 2 horas',
      read: true,
      icon: Clock,
    },
    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          {/* Dropdown */}
          <Card className="absolute right-0 top-12 w-96 max-w-[calc(100vw-2rem)] z-50 shadow-2xl border">
                    ...
                    return (
                      ...
                      >
                        <div className="flex gap-3">
                          <div className={`h-10 w-10 rounded-full flex items-center justify-center flex-shrink-0 ${getTypeStyles(notification.type)}`}>
