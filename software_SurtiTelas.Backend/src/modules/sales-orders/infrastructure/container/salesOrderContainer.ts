...
export const salesOrderUseCases = {
  ...
  acceptOrder: new AcceptOrder(orderRepository, historyRepository, receiptRepository, eventBus),
  ...
  createSale: new CreateSale(orderRepository, saleRepository, receiptRepository, historyRepository, eventBus),
