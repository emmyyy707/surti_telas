...
export const orderUseCases = {
  ...
  updateOrderFull: new UpdateOrderFull(orderRepository, eventBus),
  deleteOrder: new DeleteOrder(orderRepository, eventBus),
  assignDomiciliario: new AssignDomiciliario(orderRepository, eventBus),
